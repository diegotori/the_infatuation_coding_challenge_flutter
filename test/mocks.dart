...
class MockRepoServerApiService extends Mock implements RepoServerApiService {}

class MockSavedRepo extends Mock implements SavedRepo {}

class MockGithubRepo extends Mock implements GithubRepo {}
